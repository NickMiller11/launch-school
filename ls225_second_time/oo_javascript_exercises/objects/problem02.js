...
// Answer --> The reason is that the price is being reassigned to the discounted price, which is
// persisting in the item object.  In order to fix this, we should return the discounted price from the
// discount method without reassigning the price.