...
running total value. When you invoke either function with a number,
it should add or subtract that number from the running total and log the
new total to the console. Usage looks like this:
...
--> can't be done, trick question.  This is how to create private variables.
