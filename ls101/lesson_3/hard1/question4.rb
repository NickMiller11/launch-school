...
# determines if a string is a valid ip address number and asked Ben to use it.
...
# condition, and you're not handling the case that there are
# more or fewer than 4 components to the IP address (e.g. "4.5.5"
...
# need to add a return false case if the size of the array is not 4
# need to add a return false case if the is_an_ip_number? method returns false
