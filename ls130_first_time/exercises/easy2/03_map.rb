...
# up into an Array that is then returned to the caller.
...
rules:
- return a new array containing the results of yielding input array elements
  - to the bock

algorithm:
- use each_with_object to iterate through input array
- add result of yielding to block to new array
- return new array
