...
rules:
- return an array that contains elements that return false or nil when yielded to
  block

algorithm:
- use each_with_object to iterate through input array
- add any elements that return false or nil when yielded to block
- return array

=end

def drop_while(array)
  array.each_with_index { |el, idx| return array[idx..-1] if !yield(el) }
  Array.new
end
