...
# and none? that are similar to the standard Enumerable methods of the same names.
...
rules:
- return true if block results in true for only one element of array
- return false otherwise

algorithm:
- create a counter for true values
- iterate through array and iterate counter if true value
- evaluate true counter == 1
