...
# with any Enumerable collection).
...
rules:
- return true if all elements of collection return true after being yielded
  - to block
- return false otherwise

algorithm:
- use each to iterate over the collect
- return false if block yields false for any element
- return true
