...
rules:
- return false if any element from collection returns true when yielded
- return true otherwise

algorith:
- use each method to iterate over collect
- return false if element returns true when yielded to block
- return true
