...
rules:
- calculate the fib number for n number passed into the function
- n values of 1 and 2 both return 1

algorithm:
- create variables for first (equals 1), second (equals 1) return, and i values
- for i <= n
  - second = first
  - first = return value
