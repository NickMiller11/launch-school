...
var text = 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem ' +
...
//
// rules:
// - return a number that represents how many times the first string appears in the
//   second string
//
// algorithm:
// - use match on the second string and return the length of the resulting array
