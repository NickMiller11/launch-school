...
// The issue with this program is on line 21, where the program automatically
// updates the amount to 1 if the amount evaluates to false.  This usually works
// when the amount is not passed in as an argument, since undefined will evaluate
// to false, however when we updated the cart with a specified amount of 0, this
// was also evaluated to false and incorrectly updated to 1.